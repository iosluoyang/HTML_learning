...
function isEmail(strValue) {
    var objRegExp = /^[0-9a-zA-Z]+@[0-9a-zA-Z]+[\.]{1}[0-9a-zA-Z]+[\.]?[0-9a-zA-Z]+$/;
    return objRegExp.test(strValue)

}
/*验证手机号*/
function isPhoneNum(strValue) {
    var objRegExp = /^(\+86)?(1[0-9]{10})$/;
    return objRegExp.test(strValue)

}
/*验证身份证号（15位或18位数字)*/
function isIDCardNum(strValue) {
    var objRegExp = /^\d{15}|\d{18}$/;
    return objRegExp.test(strValue)
...
参考正则表达式:(参考来源: http://www.jianshu.com/p/4fb6354708e6)啦啦啦啦
